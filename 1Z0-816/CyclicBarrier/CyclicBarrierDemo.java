...
public class CyclicBarrierDemo {
    ...
    private int NUM_PARTIAL_RESULTS;//is the number of results that each of the worker threads is going to produce.
    private int NUM_WORKERS; // is the number of threads that are going to execute
